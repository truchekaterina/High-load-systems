...
Маленький HTTP-сервис: **`POST /publish`** с JSON телом [LAB12](../documentation/LAB12_IMPLEMENTATION_MANUAL_FULL_RU.md) → публикация **value** в топик **`hl07`**.
