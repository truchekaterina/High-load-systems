...
В папке **`zil/k6`** два артефакта для сдачи: **`load.js`** (сценарий k6) и **`run-lab4.ps1`** (несколько прогонов + встроенный рисование графика, без отдельного `.py` файла). Подробно для «с нуля» — **[`k6/README_LAB4_RU.md`](../k6/README_LAB4_RU.md)**.
