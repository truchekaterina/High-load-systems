...
| [LAB13_MANUAL_FULL_RU.md](LAB13_MANUAL_FULL_RU.md) | **LAB13**: нагрузочное тестирование стенда LAB12 — запись в Kafka (xk6-kafka или REST-прокси), batch listener, матрица CPU 0.5/1.0 × `concurrency` 1/2, топик из 2 партиций |
